...
class SecurityConfiguration(
  ...
  fun filterChain(http: ServerHttpSecurity): SecurityWebFilterChain {
    ...
    return http
      ...
      .headers{
        headers -> headers.contentSecurityPolicy{ applicationSecurityProperties.contentSecurityPolicy}
        headers.referrerPolicy{
          referrerPolicy -> referrerPolicy.policy(org.springframework.security.web.server.header.ReferrerPolicyServerHttpHeadersWriter.ReferrerPolicy.STRICT_ORIGIN_WHEN_CROSS_ORIGIN)
        }
...
//            .forEach { t: Any? ->
//              run {
//                val roleName = "ROLE_" + (t as String?)?.uppercase()
