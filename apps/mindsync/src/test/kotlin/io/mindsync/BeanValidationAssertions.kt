...
object BeanValidationAssertions {
  ...
  class BeanAsserter<T>(private val bean: T) {
  ...
  class InvalidPropertyAsserter<T>(private val beanAsserter: BeanAsserter<T>, private val violation: ConstraintViolation<T>) {
