package io.mindsync.unit.user.domain

import io.mindsync.user.domain.Name
...
class NameTest {
    ...
    fun shouldSortNames() {
        val names: List<Name> =
            Stream.of(Name("paul", "Dupond"), Name("jean", "Dupont"), Name("jean", "Dupond")).sorted().toList()
        assertThat(names).containsExactly(
            Name("jean", "Dupond"), Name("jean", "Dupont"), Name("paul", "Dupond")
        )
    }
}